...
import { googleLogin, googleLoginCallback, login, register } from "../controllers/authController";
...
authRoutes
    ...
    .get("/google-login-callback", validate({ query: googleLoginQueryValidator }), googleLoginCallback)
